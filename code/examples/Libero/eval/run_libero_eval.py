...
# PATCHED (QuantVLA v2): per-shard log isolation for multi-GPU task sharding.
log_dir = os.environ.get("LIBERO_LOG_DIR", "/tmp/logs")
...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    for task_id in tqdm.tqdm(task_indices):
        ...
        env, task_description = get_libero_env(task, resolution=256, seed=cfg.seed)
